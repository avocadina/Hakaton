                      ...
                      for (var w in e)
                        if (typeof e[w] === a && e[w].length > 0) {
                          for (var i = 0; i < e[w].length; i++)
                            if (F(e[w][i], A)) return "?" === w ? n : w;
                        } else if (F(e[w], A)) return "?" === w ? n : w;
                      return A;
                    },
                    _ = {
                      ME: "4.90",
      ...
      1173: (A, e, w) => {
        ...
        let a = "force-static",
          s = new r.AppRouteRouteModule({
            ...
            resolvedPagePath:
              "next-metadata-route-loader?filePath=C%3A%5Cnext%5CHakaton%5Csrc%5Capp%5Cfavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__",
